...
convArgToPrologVarName(Str__argName, Str__SrcPrologVarName) :-
    %strFormat("VArg__~w", [Str__argName], Str__SrcPrologVarName),
...
emitPrologFunctionForAst__Recursive(Val, ctx(PredIdCounterIn), ctx(PredIdCounterOut), List__EntryPredicateArgs, Set__Str__letVariableNames, List__Str__functionNames,    Str__SrcProlog__dest, PredIdCounterIn) :-
    ...
    % concat
    convListOfArgumentsToPrologSrc(List__EntryPredicateArgs,   Str__SrcProlog__Args),
    
    % we have to emit the leading Prolog predicate head
    strFormat("pred~w(runtimeCtx(), runtimeCtx() ~w [],   Res) :- % generated by GENconstA~n", [PredIdCounterIn, Str__SrcProlog__Args],   T0),
    
    %write("DBG AAA"),nl, % DBG
    %write(Str__SrcProlog__Args),nl, % DBG
    %halt, % HACKS
...
%genCodeV2_invocation(Str__invokedPredicateId, Str__srcProlog__args) -->
genCodeV2_invocation(Str__invokedPredicateId) -->
    %"\n:- __pred",Str__invokedPredicateId,"(runtimeCtx(), runtimeCtx(), ",Str__srcProlog__args,", Res).  % invoke predicate\n".
    "\n:- pred",Str__invokedPredicateId,"(runtimeCtx(), runtimeCtx(), ","[]",", Res).  % invoke predicate\n".
...
% /param AstNode__headArgument   is the AST-node of the head of the MeTTa function definition as a decoratedMettaExpr(<DECORATION>, <CONTENT>)
emitPrologFunctionOfMettaFunctionInvocation(
    mettaFunctionInvocation(AstNode__body__in), % FIXME : take the correct parameters here
    ctx(PredIdCounterIn), ctx(PredIdCounterOut), List__Str__functionNames,    Str__SrcProlog__dest%, Int__PredicateIdRes
) :-

    List__EntryPredicateArgs = [],
    Set__Str__letVariableNames = [],
    emitPrologFunctionForAst__Recursive(AstNode__body__in, ctx(PredIdCounterIn), ctx(PredIdCounterOut), List__EntryPredicateArgs, Set__Str__letVariableNames, List__Str__functionNames,    Str__SrcProlog__generatedPredicate, Int__PredicateIdGenerated),



    Int__invokedPredicateId = Int__PredicateIdGenerated,
    convIntToStr(Int__invokedPredicateId,    Str__invokedPredicateId),
    phrase(genCodeV2_invocation(Str__invokedPredicateId), Chars), !, string_chars(Str__srcProlog__invokeSite, Chars),



    strConcat([Str__SrcProlog__generatedPredicate, "\n\n", Str__srcProlog__invokeSite],   Str__SrcProlog__dest),
...
% test with 
% AstNode__body__in = 1,
% List__Str__functionNames = [],
% emitPrologFunctionOfMettaFunctionInvocation(
%    mettaFunctionInvocation(AstNode__body__in), 
%    ctx(0), ctx(PredIdCounterOut), List__Str__functionNames,    Str__SrcProlog__dest
%).
...
emitPrologFunctionOfMettaFunctionInvocations(
    [],
    ctx(PredIdCounter), ctx(PredIdCounter), _,    ""
) :-
    true.
...
emitPrologFunctionOfMettaFunctionInvocations(
    [mettaFunctionInvocation(AstNode__body__in)|List__tail],
    ctx(PredIdCounterIn), ctx(PredIdCounterOut), List__Str__functionNames,    Str__SrcProlog__dest
) :-
...
% TODO : implement function to filter mettaFunctionInvocation from AST-list . then call into emitPrologFunctionOfMettaFunctionInvocations/5
